...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-xl border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all duration-200 outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:scale-[0.98] disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-to-r from-primary via-primary to-primary/90 text-primary-foreground shadow-sm shadow-primary/25 hover:shadow-md hover:shadow-primary/35 hover:-translate-y-0.5 active:translate-y-0",
        outline:
          "border-border/80 bg-background/80 backdrop-blur-xs shadow-2xs hover:border-primary/40 hover:bg-accent/50 hover:text-foreground hover:-translate-y-0.5 active:translate-y-0 aria-expanded:bg-muted aria-expanded:text-foreground dark:border-white/10 dark:bg-card/40 dark:hover:bg-white/10",
        secondary:
          "bg-secondary text-secondary-foreground shadow-2xs hover:bg-[color-mix(in_oklch,var(--secondary),var(--foreground)_6%)] hover:-translate-y-0.5 active:translate-y-0 aria-expanded:bg-secondary aria-expanded:text-secondary-foreground",
        ghost:
